    ...
    private:
        ...
        */
        ...
        /*
            ...
            del elemento.
        */
        static void calculate_local_A(DS<float>* A, Point* P1, Point* P2, Point* P3){ // Alpha 
    ...
    public:
        ...
        */
        static DS<float>* calculate_local_M(Element* e){
            ...
            //Se definen los elementos de la matriz de acuerdo a la fórmula posición por posición
            SDDS<float>::insert(M,0,0,(1/45)); SDDS<float>::insert(M,0,1,(1/120)); SDDS<float>::insert(M,0,2,(1/120));
            SDDS<float>::insert(M,1,0,(1/120)); SDDS<float>::insert(M,1,1,(1/30)); SDDS<float>::insert(M,1,2,(1/120));
            SDDS<float>::insert(M,2,0,(1/60)); SDDS<float>::insert(M,2,1,(1/20)); SDDS<float>::insert(M,2,2,(1/60));
        ...
        */
        static DS<float>* calculate_local_K_1(Element* e){
        ...
        static DS<float>* calculate_local_K_2(Element* e){
            //Se preparan las variables para el proceso
            DS<float> *A, *B, *K;
            ...
            SDDS<float>::create(&Mt,3,2, MATRIX);
                /*
                    |1/60 | 1/60 |
                    |1/60 | 1/60 |
                    |1/20 | 1/20 |
                */
            SDDS<float>::insert(Mt,0,0,(1/60)); SDDS<float>::insert(Mt,0,1,(1/60)); 
            SDDS<float>::insert(Mt,1,0,(1/60)); SDDS<float>::insert(Mt,1,1,(1/60));
            SDDS<float>::insert(Mt,2,0,(1/20)); SDDS<float>::insert(Mt,2,1,(1/20));

            // (Mt*a) * (B)
            DS<float>* temp = Math::product( Mt, A );
            K = Math::product( temp, B );
