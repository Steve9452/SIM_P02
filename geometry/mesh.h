...
enum parameter {DIRICHLET_VALUE,NEUMANN_VALUE,INITIAL_WATER,TIME_STEP,INITIAL_TIME,FINAL_TIME};
    ...
    public:
        ...
        */
        Mesh(){
            ...
            // Parametros: Ad, An, Initial A, Delta t, t0, t1
            // Ad y An -> Corresponde a cantidad de nodos de Dirichlet y Neumman 
            SDDS<float>::create(&parameters,6,ARRAY);
            // Cantidad de nodos de Dirichlet
        ...
        */
        void set_parameters(float Ad, float An, float initial_A, float delta_t, float t_0, float t_f){
            ...
            SDDS<float>::insert(parameters,INITIAL_WATER,initial_A);
